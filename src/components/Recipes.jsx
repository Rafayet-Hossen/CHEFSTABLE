      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-4 w-11/12 mx-auto">
        {recipes.map((recipes) => (
          <div
            ...
            className="card card-normal bg-base-100 border-2 card-bordered"
          >
            ...
            <div className="p-7 space-y-2">
              ...
              <div className="mt-1">
                <button onClick={() => {addRecipeQueue(recipes)}} className="px-5 py-2 border font-semibold rounded-full bg-[#0be58a] shadow hover:bg-[#35f3a3]">
                  Want to Cook
                </button>
              </div>
            </div>
